 ...
 */
export type MessageType = 'player:join' | 'player:leave' | 'player:ready' | 'player:answer' | 'player:vote' | 'player:shake' | 'game:start' | 'game:phase' | 'game:timer' | 'game:end' | 'host:settings' | 'sync:state';
