...
export const GameRules = {
   ...
   */
  canStartGame(state: GameState): { canStart: boolean; reason?: string } {
  ...
  determineVoteWinner(
    ...
    playerBId: string,
    votes: Map<string, string>
  ): { winnerId: string | null; votesA: number; votesB: number } {
    let votesA = 0;
    let votesB = 0;
   ...
   */
  isValidPlayerName(name: string): { valid: boolean; reason?: string } {
